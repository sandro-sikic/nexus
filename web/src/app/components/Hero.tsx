	...
	return (
		<section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
			...
			<div className="max-w-6xl mx-auto text-center relative z-10">
				...
				>
					Stop memorizing commands. Nexus transforms your scattered terminal
					commands into a clean, interactive TUI that works anywhere.
				</motion.p>
				...
				>
					<a
						href="https://github.com/sandro-sikic/nexus/releases/tag/latest"
						className="group relative inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg overflow-hidden transition-all hover:scale-105"
					>
					...
					<a
						...
						className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-all hover:border-white/20 backdrop-blur-sm"
					>
